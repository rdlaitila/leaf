...
#include <lua51/csrc/lualib.h>
#include <stddef.h>
#include <stdlib.h>

extern void lua51_luainit(lua_State*);
extern void lua51_pushclosure(lua_State*, int);
*/
import "C"
...
func docallback(stateindex C.float, funcindex C.float) int {
    // pull our *State value and Function value from GovalueRegistry
