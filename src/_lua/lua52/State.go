...
extern void lua52_luainit(lua_State*);
extern void lua52_pushclosure(lua_State*, int);
*/
import "C"
...
func (this *State) Yield(nresults int) int {
	return int(C.lua_yieldk(this.luastate, C.int(nresults), C.int(0), nil))
}
...
func (this *State) Pushclosure(fn lua.Function, n int) {
	...
	C.lua52_pushclosure(this.luastate, C.int(n + 2))
}
...
func (this *State) Call(nargs, nresults int) {
	C.lua_callk(this.luastate, C.int(nargs), C.int(nresults), C.int(0), nil)
}
